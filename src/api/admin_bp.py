...
def show_hello_world():
     return "Servidor Python funcionando",200
...
def create_user():
    try:
        ...
        good_to_share_user = {
            ...
            #'password':password #Se elimina esta linea porque no es seguro el envio de las contraseñas
        }

        return jsonify({'message': 'User created successfully.','user_created':good_to_share_user}), 201 #Código que todo salio bien y se creo algo

    except Exception as e:
        return jsonify({'error': 'Error in user creation: ' + str(e)}), 500 #Código de error de servidor
